<template>
  <div class="wrapper">
    <div class="content">
      <!-- Judul -->
      <h2 class="title">Gapura - Taman Sari</h2>

      <!-- Gambar utama -->
      <img src="@/assets/Gapura Taman Sari.jpg" alt="Gapura Taman Sari" class="main-image" />

      <!-- Daftar Gapura -->
      <section class="details">
        <h3>Berikut beberapa gapura yang ada di Taman Sari:</h3>
...
export default {
  ...
  methods: {
    ...
    // Mengambil daftar Gapura di Taman Sari
    fetchGapuras() {
